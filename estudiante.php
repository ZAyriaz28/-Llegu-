...
// NUEVO: Verificar faltas consecutivas para la advertencia
...
.nav-item { color: var(--text-muted); text-align: center; cursor: pointer; flex: 1; transition: 0.3s; }
        ...
        /* Estilo para la advertencia de deserción */
        .alert-desercion {
            ...
            <div class="alert-desercion animate__animated animate__shakeX">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <p class="small mb-0" style="font-size: 0.7rem; line-height: 1.2;">
                            Has faltado a las últimas <b><?= $mis_faltas_seguidas ?> sesiones</b>. Estás en riesgo de ser eliminado del sistema. Justifica tus faltas pronto.
                        </p>
                    </div>
                </div>
            </div>
...
<div class="d-flex justify-content-between align-items-center mb-2">
                    ...
                    <span class="small fw-bold text-muted-custom">ASISTENCIA</span>
...
<h6 class="fw-bold mb-1">Ciberseguridad y Redes</h6>
                ...
                <p class="small text-muted-custom mb-0">Laboratorio A1 - Somoto</p>
</div>
...
<div class="glass-card text-center py-3" style="border: 1px dashed var(--tech-cyan);">
                ...
                <p class="small text-muted-custom mb-1 text-uppercase fw-bold">Llave Dinámica</p>
...
<h6 class="fw-bold mb-0"><?= $nombre ?></h6>
    ...
    <div class="qr-fab pulse-animation" id="btnAsistenciaCheck" onclick="confirmarFinalizado()" style="background: linear-gradient(135deg, var(--primary-blue), var(--tech-cyan)); shadow: 0 0 15px var(--tech-cyan);">
...
<h6 class="fw-bold"><?= $nombre ?></h6>
            ...
            <div class="glass-card mt-4 p-3 text-start">
                <label class="small fw-bold text-muted-custom">CORREO</label>
